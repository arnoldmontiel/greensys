...
class PriceListItemController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['PriceListItem']))
		{
			$model->attributes=$_POST['PriceListItem'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('PriceListItem');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='price-list-item-form')
		{

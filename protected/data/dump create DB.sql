...
CREATE TABLE `multimedia` (
  ...
  `Id_product` int(11) DEFAULT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_multimedia_entity_type1` (`Id_entity_type`),
  KEY `fk_multimedia_product1` (`Id_product`),
  CONSTRAINT `fk_multimedia_entity_type1` FOREIGN KEY (`Id_entity_type`) REFERENCES `entity_type` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_multimedia_product1` FOREIGN KEY (`Id_product`) REFERENCES `product` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product` (
  ...
  `amperage` decimal(10,2) DEFAULT '0.00',
...
-- Dump completed on 2012-05-21 11:23:18

...
class TMultimediaController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['TMultimedia']))
		{
			$file = $_FILES["TMultimedia"];
			$model->uploadedFile = $file;
			$model->attributes=$_POST['TMultimedia'];
			$model->Id_customer = 1;
	...
	{
		$dataProvider=new CActiveDataProvider('TMultimedia');
	...
	{
		$model=new TMultimedia('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['TMultimedia']))
			$model->attributes=$_GET['TMultimedia'];
	...
	{
		$model=TMultimedia::model()->findByPk($id);
		if($model===null)

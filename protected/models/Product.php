...
class Product extends ModelAudit
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('description_customer, short_description, part_number, url, tags, 
			...
			array('date_creation,description_supplier, long_description, input_terminals, input_signals, input_labels, output_terminals, output_signals, output_labels, commercial_description', 'safe'),

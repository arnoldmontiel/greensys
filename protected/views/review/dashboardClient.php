...
function doFilter()
{
		...
		$.post('".ReviewController::createUrl('AjaxFillClientDashboard')."', 
		{
		...
		function(data){
			...
			if('".$browser['browser']."'=='IE')
			{
				$('#file_upload').uploadify({
			        ...
			        'uploader' : '".Yii::app()->createUrl('album/AjaxUploadify')."&idAlbum='+$('#uploadify_id_album').val()+'&idCustomer='+$('#uploadify_id_customer').val()+'&idProject='+$('#uploadify_id_project').val(),
...
<?php endif;?>
	...
	<?php
			...
			echo CHtml::link('Administrador',
				Yii::app()->createUrl('initCustomer/admin'),
...
<?php 
$tCustomer = TCustomer::model()->findByPk($Id_customer);
if(isset($tCustomer))
{
	$this->widget('bootstrap.widgets.TbDetailView', array(
			'data'=>$tCustomer,
			'attributes'=>array(
					array('label'=>$tCustomer->getAttributeLabel('description'),
							'type'=>'raw',
							'value'=>$tCustomer->contact->description
					),
					array('label'=>$tCustomer->getAttributeLabel('name'),
							'type'=>'raw',
							'value'=>$tCustomer->person->name
					),
					array('label'=>$tCustomer->getAttributeLabel('last_name'),
							'type'=>'raw',
							'value'=>$tCustomer->person->last_name
					),
					array('label'=>$tCustomer->getAttributeLabel('email'),
							'type'=>'raw',
							'value'=>$tCustomer->contact->email
					),
					array('label'=>$tCustomer->getAttributeLabel('address'),
							'type'=>'raw',
							'value'=>$tCustomer->contact->address
					),
					array('label'=>$tCustomer->contact->getAttributeLabel('telephone_1'),
							'type'=>'raw',
							'value'=>$tCustomer->contact->telephone_1
					),
					array('label'=>$tCustomer->contact->getAttributeLabel('tel1_description'),
							'type'=>'raw',
							'value'=>$tCustomer->contact->tel1_description
					),
					array('label'=>$tCustomer->contact->getAttributeLabel('telephone_2'),
							'type'=>'raw',
							'value'=>$tCustomer->contact->telephone_2
					),		
					array('label'=>$tCustomer->contact->getAttributeLabel('tel2_description'),
							'type'=>'raw',
							'value'=>$tCustomer->contact->tel2_description
					),
					array('label'=>$tCustomer->contact->getAttributeLabel('comment'),
							'type'=>'raw',

...
<div id="customer" class="wall-action-ddl" >
	<?php echo CHtml::label($modelCustomer->person->name.' '.$modelCustomer->person->last_name,'Id_customer'); ?>
</div>
...
<?php echo $this->renderPartial('_form', array('model'=>$model,'modelReviewType'=>$modelReviewType)); ?>
</div>

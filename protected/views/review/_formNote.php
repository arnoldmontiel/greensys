...
?>
	...
	<div class="row">
		<?php echo $formNote->textArea($model,'note',array('rows'=>15, 'cols'=>110,'class'=>'wall-action-upload-file-description','style'=>'margin-left:1%;', 'placeholder'=>'Escriba una nota...')); ?>

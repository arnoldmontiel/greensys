<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'action'=>Yii::app()->createUrl("service/ajaxCreate")		
)); ?>
  ...
  <?php echo $form->labelEx($model,'long_description'); ?>
    <?php echo $form->textArea($model,'long_description',array("class"=>"form-control","rows"=>'12')); ?>
      ...
      <div class="modal-footer">
        ...
        <button id ="saveService" type="button" class="btn btn-primary btn-lg"><i class="fa fa-save"></i> Guardar</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
<?php $this->endWidget(); ?>
...
$('#saveService').click(function()
		...
		jQuery.post('<?php 
			if($model->isNewRecord)	echo Yii::app()->createUrl("service/ajaxCreate");
			else 	echo Yii::app()->createUrl("service/ajaxUpdate");
			?>', $('#service-form').serialize(),
						function(data) {
							if(data!=null)
							{	

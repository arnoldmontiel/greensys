...
<div class="container" id="screenAgregarProductos">
  ...
  <div class="row">
   ...
   <div class="row">
    <div class="col-sm-4">
      ...
      <table class="table table-striped table-bordered tablaIndividual" width="100%">
        <tbody>
          ...
          <tr>
            <td style="text-align:right;"><label for="campoEnvio">Envío por defecto</label></td>
            <td><input type="model" id="campoEnvio" class="form-control"></td>
          </tr>
          <tr>
            <td style="text-align:right;"><label for="campoEnvio2">Envío por defecto</label></td>
    ...
    <!-- /.col-sm-4 -->
    <div class="col-sm-4">
      <div class="rowSeparator noTopMargin">MEDIDAS CAJA ENVÍO</div>
      <table class="table table-striped table-bordered tablaIndividual" width="100%">
        <tbody>
          <tr>
...
<!--MODAL AGREGADO RAPIDO-->
<div class="modal fade" id="myModalRapido">
...
<form role="form">
  <div class="form-group">
    <label for="campoNombreMarca">Nombre</label>
    <input type="model" id="campoNombreMarca" class="form-control">
  </div>
</form>
      </div>
